 ...
 */
#undef LOG_TAG
#define LOG_TAG "NapiAudioRendererCallbackInner"
...
void NapiAudioRendererCallbackInner::SaveCallbackReferenceInner(const std::string &callbackName, napi_value args,
    std::function<void(std::shared_ptr<AutoRef> generatedCallback)> successed)
{
    CHECK_AND_RETURN_LOG(CheckIfTargetCallbackName(callbackName),
        "NapiAudioRendererCallbackInner-> SaveCallbackReferenceInner UnKnown callback type: %{public}s",
        callbackName.c_str());
...
bool NapiAudioRendererCallbackInner::ContainSameJsCallbackInner(const std::string &callbackName, napi_value args)
{
    CHECK_AND_RETURN_RET_LOG(CheckIfTargetCallbackName(callbackName), false,
        "NapiAudioRendererCallbackInner->ContainSameJsCallbackInner Unknown callback type: %{public}s",
        callbackName.c_str());
...
void NapiAudioRendererCallbackInner::RemoveCallbackReferenceInner(
