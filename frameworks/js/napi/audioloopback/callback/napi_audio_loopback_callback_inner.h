 ...
 */
#ifndef NAPI_AUDIO_LOOPBACK_CALLBACK_INNER_H
#define NAPI_AUDIO_LOOPBACK_CALLBACK_INNER_H
#include "napi_async_work.h"

namespace OHOS {
namespace AudioStandard {
class NapiAudioLoopbackCallbackInner {
public:
    virtual void SaveCallbackReference(const std::string &callbackName, napi_value args) = 0;
    virtual void RemoveCallbackReference(const std::string &callbackName, napi_env env,
        napi_value callback, napi_value args) = 0;
...
#endif // NAPI_AUDIO_LOOPBACK_CALLBACK_INNER_H