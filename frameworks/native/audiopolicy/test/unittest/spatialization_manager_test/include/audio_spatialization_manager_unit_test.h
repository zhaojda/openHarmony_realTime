...
#ifndef AUDIO_SPATIALIZATION_MANAGER_UNIT_TEST_H
#define AUDIO_SPATIALIZATION_MANAGER_UNIT_TEST_H
...
class AudioSpatializationManagerUnitTest : public testing::Test {
public:
...
#endif // AUDIO_SPATIALIZATION_MANAGER_UNIT_TEST_H
