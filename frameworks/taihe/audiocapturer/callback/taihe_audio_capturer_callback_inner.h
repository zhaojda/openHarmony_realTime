...
#ifndef TAIHE_AUDIO_CAPTURER_CALLBACK_INNER_H
#define TAIHE_AUDIO_CAPTURER_CALLBACK_INNER_H
...
class TaiheAudioCapturerCallbackInner {
public:
...
#endif // TAIHE_AUDIO_CAPTURER_CALLBACK_INNER_H
