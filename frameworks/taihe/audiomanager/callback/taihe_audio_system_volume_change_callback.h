...
#ifndef TAIHE_AUDIO_SYSTEM_VOLUME_CHANGE_CALLBACK_H
#define TAIHE_AUDIO_SYSTEM_VOLUME_CHANGE_CALLBACK_H
...
class TaiheAudioSystemVolumeChangeCallback : public OHOS::AudioStandard::SystemVolumeChangeCallback,
    public std::enable_shared_from_this<TaiheAudioSystemVolumeChangeCallback> {
public:
...
private:
    ...
    static void SafeJsCallbackSystemVolumeChangeWork(AudioSystemVolumeChangeJsCallback *event);
...
#endif // TAIHE_AUDIO_SYSTEM_VOLUME_CHANGE_CALLBACK_H