 ...
 */
#undef LOG_TAG
#define LOG_TAG "TaiheAudioLoopbackCallbackInner"

#include "taihe_audio_loopback_callback_inner.h"
#include "taihe_param_utils.h"

namespace ANI::Audio {
void TaiheAudioLoopbackCallbackInner::SaveCallbackReferenceInner(const std::string &callbackName,
    std::shared_ptr<uintptr_t> callback, std::function<void(std::shared_ptr<AutoRef> generatedCallback)> successed)
{
    CHECK_AND_RETURN_LOG(CheckIfTargetCallbackName(callbackName),
        "TaiheAudioLoopbackCallbackInner-> SaveCallbackReferenceInner UnKnown callback type: %{public}s",
        callbackName.c_str());
...
bool TaiheAudioLoopbackCallbackInner::ContainSameJsCallbackInner(const std::string &callbackName,
    std::shared_ptr<uintptr_t> callback)
{
    CHECK_AND_RETURN_RET_LOG(CheckIfTargetCallbackName(callbackName), false,
        "TaiheAudioLoopbackCallbackInner->ContainSameJsCallbackInner Unknown callback type: %{public}s",
        callbackName.c_str());
...
void TaiheAudioLoopbackCallbackInner::RemoveCallbackReferenceInner(const std::string &callbackName,
    std::shared_ptr<uintptr_t> callback, std::function<void()> successed)
{
    CHECK_AND_RETURN_LOG(CheckIfTargetCallbackName(callbackName),
