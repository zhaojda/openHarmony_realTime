...
void TaiheDfxUtils::SendVolumeApiInvokeEvent(int32_t uid, const std::string &functionName, int32_t paramValue)
{
#ifndef CROSS_PLATFORM
...
void TaiheDfxUtils::ReportAudioMainThreadEvent(int32_t uid, bool direction,
