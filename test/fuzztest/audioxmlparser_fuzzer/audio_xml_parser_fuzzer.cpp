...
void HasPropFuzzTest()
{
    shared_ptr<AudioXmlNode> ptr = AudioXmlNode::Create();
    if (ptr == nullptr) {
        return;
    }
    ptr->HasProp("abc");
...
void GetContentFuzzTest()
{
    ...
    ptr->GetContent(result);
}

void OperatorFuzzTest()
{
    shared_ptr<AudioXmlNode> ptr1 = AudioXmlNode::Create();
