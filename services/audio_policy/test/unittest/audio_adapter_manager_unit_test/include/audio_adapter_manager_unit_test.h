...
#ifndef AUDIO_ADAPTER_MANAGER_UNIT_TEST_H
#define AUDIO_ADAPTER_MANAGER_UNIT_TEST_H
...
class AudioAdapterManagerUnitTest : public testing::Test {
public:
...
#endif //AUDIO_ADAPTER_MANAGER_UNIT_TEST_H