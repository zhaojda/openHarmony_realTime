...
#ifndef AUDIO_SESSION_SERVICE_UNIT_TEST_H
#define AUDIO_SESSION_SERVICE_UNIT_TEST_H
...
class AudioSessionServiceUnitTest : public testing::Test {
public:
...
#endif //AUDIO_SESSION_SERVICE_UNIT_TEST_H
