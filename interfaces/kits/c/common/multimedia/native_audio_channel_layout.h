 ...
 *
 * A 64-bit integer indicates that the appearance and order of the speakers for
...
typedef enum OH_AudioChannelLayout {
    ...
    /** Channel Layout For ORDER1-ACN-N3D First Order Ambisonic(FOA), 4 channels
       in total */
    ...
    /** Channel Layout For ORDER2-ACN-N3D Higher Order Ambisonics(HOA), 9 channels
       in total */
